...
Estos serían los pasos de un ejemplo sencillo de como almacenar passwords en ficheros solo accesibles por un usuario determinado que previamente las guarda cifradas en los ficheros:
